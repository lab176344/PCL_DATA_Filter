		...
		*/
			...
			if (bounding)
			{
				...
				for (int i = 0; i < cloud_cluster_vector.size(); i++)
				{
					...
					if ((max_point_AABB.z - min_point_AABB.z) > 0.5)
					{
